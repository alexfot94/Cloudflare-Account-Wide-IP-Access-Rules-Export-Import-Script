# === Cloudflare Account-Wide IP Access Rules Export ===
...
$successListFile  = "$env:USERPROFILE\Desktop\account_export_success_summary.txt"
$failedListFile   = "$env:USERPROFILE\Desktop\account_export_failed_summary.txt"
...
Write-Host "`n=== Starting Cloudflare Account-Level IP Access Rule Export ===" -ForegroundColor Cyan

do {
    $url = "https://api.cloudflare.com/client/v4/user/firewall/access_rules/rules?page=$page&per_page=$perPage"
